var perConfig = [
    {
        ...
        tableTitle: '系统功能',
        page: [
            "3001,'设备数据(Web)','AlarmCenter.RealTime','1','1'",
            "3002,'实时快照(Web)','AlarmCenter.ActualSys','1','1'",
            "3003,'系统配置(Web)','AlarmCenter.Systems','1','1'",
            "3004,'事件查询(Web)','AlarmCenter.EvtSelect','1','1'",
            "3005,'报警排表(Web)','AlarmCenter.AlarmTabulate','1','1'",
            "3006,'定时任务(Web)','AlarmCenter.TimedTask','1','1'",
            "3007,'设备联动(Web)','AlarmCenter.EquipLink','1','1'",
            "3008,'实时快照(App)','AlarmCenter.App.MessageTool','1','1'",
            "3009,'设备数据(App)','AlarmCenter.App.RealTimeTool','1','1'",
            "3010,'语音控制(App)','AlarmCenter.App.VoiceTool','1','1'",
			"3011,'视频系统(App)','AlarmCenter.App.VideoTool','1','1'"
        ]
    },
    {
