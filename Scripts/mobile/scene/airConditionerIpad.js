...
function airConditionerIpad() {
	width = $(".contentDivAirIpadCenter").position().left - $("#clockChoiceAirIpad").position().left; // 桌布宽度
	height = $(".contentDivAirIpadleftFoot").position().top - $("#clockChoiceAirIpad").position().top; // 桌布高度
	dot = {
		x: parseInt(width / 2),
		y: parseInt(height / 2),
		radius: 6
	...
	circleX = dot.x + $("#clockChoiceAirIpad").position().left;
	circleY = dot.y + $("#clockChoiceAirIpad").position().top;
	scaleRadius = benchmark * 2 / 3; // 圆半径
	borderWidth = radius / 20; // 圆边框宽度
	length = circleRadius * 3 / 4;
	clock = document.getElementById('clockChoiceAirIpad');
	//	$("#clockChoiceAirIpad").html("");//清空填充内容，以再次填充
...
function initData() {
	/* 风量高切换效果 */
	$("#airHigher").bind('touchstart', function() {
		$(".contentDivAirIpadRightCenterPic font").css("color", "#c1c1c1");
		$(".contentDivAirIpadRightCenterPic").css("background-image", "url(/Image/scene/air/air_high.png)");
		$("#airHigher font").css("color", "#be992a");
	});
	/*$("#airHigher").bind('touchend', function() {
		$(".contentDivAirIpadRightCenterPic").css("background-image", "url(/Image/scene/air/air_no_steup.png)");
		$("#airHigher font").css("color", "#c1c1c1");
	});*/

	/* 风量中切换效果 */
	$("#airIn").bind('touchstart', function() {
		$(".contentDivAirIpadRightCenterPic font").css("color", "#c1c1c1");
		$(".contentDivAirIpadRightCenterPic").css("background-image", "url(/Image/scene/air/air_in.png)");
		$("#airIn font").css("color", "#be992a");
	});
	/*$("#airIn").bind('touchend', function() {
		$(".contentDivAirIpadRightCenterPic").css("background-image", "url(/Image/scene/air/air_no_steup.png)");
		$("#airIn font").css("color", "#c1c1c1");
	});*/

	/* 风量低切换效果 */
	$("#airlower").bind('touchstart', function() {
		$(".contentDivAirIpadRightCenterPic font").css("color", "#c1c1c1");
		$(".contentDivAirIpadRightCenterPic").css("background-image", "url(/Image/scene/air/air_lower.png)");
		$("#airlower font").css("color", "#be992a");
	});
	/*$("#airlower").bind('touchend', function() {
		$(".contentDivAirIpadRightCenterPic").css("background-image", "url(/Image/scene/air/air_no_steup.png)");
		$("#airlower font").css("color", "#c1c1c1");
	});*/

	/* 模式制冷切换效果 */
	$("#airZhileng").bind('touchstart', function() {
		$(".contentDivAirIpadRightFooterPic i").css("color", "#c1c1c1");
		$(".contentDivAirIpadRightFooterPic").css("background-image", "url(/Image/scene/air/air_zhileng.png)");
		$("#airZhileng i").css("color", "#be992a");
	});
	/*$("#airZhileng").bind('touchend', function() {
		$(".contentDivAirIpadRightFooterPic").css("background-image", "url(/Image/scene/air/air_nochoice.png)");
		$("#airZhileng i").css("color", "#c1c1c1");
	});*/

	/* 模式除湿切换效果 */
	$("#airChushi").bind('touchstart', function() {
		$(".contentDivAirIpadRightFooterPic i").css("color", "#c1c1c1");
		$(".contentDivAirIpadRightFooterPic").css("background-image", "url(/Image/scene/air/air_chushi.png)");
		$("#airChushi i").css("color", "#be992a");
	});
	/*$("#airChushi").bind('touchend', function() {
		$(".contentDivAirIpadRightFooterPic").css("background-image", "url(/Image/scene/air/air_nochoice.png)");
		$("#airChushi i").css("color", "#c1c1c1");
	});*/

	/* 模式送风切换效果 */
	$("#airSongfeng").bind('touchstart', function() {
		$(".contentDivAirIpadRightFooterPic i").css("color", "#c1c1c1");
		$(".contentDivAirIpadRightFooterPic").css("background-image", "url(/Image/scene/air/air_wind.png)");
		$("#airSongfeng i").css("color", "#be992a");
	});
	/*$("#airSongfeng").bind('touchend', function() {
		$(".contentDivAirIpadRightFooterPic").css("background-image", "url(/Image/scene/air/air_nochoice.png)");
		$("#airSongfeng i").css("color", "#c1c1c1");
	});*/

	/* 模式制热切换效果 */
	$("#airZhire").bind('touchstart', function() {
		$(".contentDivAirIpadRightFooterPic i").css("color", "#c1c1c1");
		$(".contentDivAirIpadRightFooterPic").css("background-image", "url(/Image/scene/air/air_zhire.png)");
		$("#airZhire i").css("color", "#be992a");
	});
	/*$("#airZhire").bind('touchend', function() {
		$(".contentDivAirIpadRightFooterPic").css("background-image", "url(/Image/scene/air/air_nochoice.png)");
		$("#airZhire i").css("color", "#c1c1c1");
	});*/
...
function drawDescFont() {
	//设置字体样式
	bgCtx.font = "16px 'microsoft yahei'"; //20px '微软雅黑' 
	//设置字体填充颜色
...
function drawTextFont(number) {
	...
	textCtx.font = "28px 'microsoft yahei'";
	...
	textCtx.font = "18px 'microsoft yahei'";
	textCtx.shadowBlur = 5;
	textCtx.shadowOffsetX = 0;
	textCtx.shadowColor = "#25313c";
